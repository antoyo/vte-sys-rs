...
pub const VTE_MICRO_VERSION: i32 = 2;
pub const VTE_MINOR_VERSION: i32 = 40;
...
#[repr(C)]
pub struct VteTerminalPrivate(c_void);
...
extern "C" {
    ...
    pub fn vte_terminal_match_add_gregex(terminal: *mut VteTerminal, regex: *mut glib::GRegex, flags: glib::GRegexMatchFlags) -> c_int;
    ...
    pub fn vte_terminal_search_set_gregex(terminal: *mut VteTerminal, regex: *mut glib::GRegex, flags: glib::GRegexMatchFlags);
